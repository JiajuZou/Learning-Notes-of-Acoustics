...
\usepackage{graphicx}
\usepackage{setspace}
\usepackage[justification=centering]{caption} % 加载caption宏包并设置居中
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{Fig.1.2.1.jpg} % 替换为你的图片文件名
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{Fig.Conservation of Momentum.jpg} % 替换为你的图片文件名
